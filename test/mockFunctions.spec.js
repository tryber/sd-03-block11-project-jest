...
describe('verifica as funções e os mocks', () => {
  ...
  mockFunctions.power = jest.fn.mockImplementation((a, b) => Matgith.pow(a, b));
  mockFunctions.factorial = jest.fn.mockImplementation((a)=> (a === 0 || a === 1)? 1 :a * mockFuncitions.factorial(a - 1));
