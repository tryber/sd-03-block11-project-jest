...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    ...
    add = jest.fn().mockImplementation((n1, n2) => n1 + n2);
  ...
  test('testa função subtract', () => {
    subtract = jest.fn().mockImplementation((n1, n2) => n1 - n2);
  ...
  test('testa função multiply', () => {
    multiply = jest.fn().mockImplementation((n1, n2) => n1 * n2);
  ...
  test('testa função divide', () => {
    divide = jest.fn().mockImplementation((n1, n2) => n1 / n2);
  ...
  test('testa função factorial', () => {
    factorial = jest.fn().mockImplementation((num) => {
      let res = 1;
